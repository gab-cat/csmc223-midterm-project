...
| **MOD 08**  | `MOD [DIVIDEND_REGISTER] [DIVISOR_REGISTER]` | Computes the remainder of dividing one value by another and stores the result in a register.   | `MOD 03 04`<br>(Computes the remainder of dividing the value in R3 by the value in R4, storing the result in R3) |
...
### Sample Terminal Display after running of code
   ```cmd
